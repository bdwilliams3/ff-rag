...
IMPORTANT_COLUMNS = {
    ...
    "current_coaching_staff": [
        ...
        "current_oc_name",
        "current_oc_since",
        "current_oc_previous_position",
        "source_name",
        "source_confidence",
        "hc_historical_oc_profile_count",
        "hc_historical_oc_profile_seasons",
        "hc_historical_oc_profile_teams",
        "hc_historical_avg_pass_rate",
        "hc_historical_avg_run_rate",
        "hc_historical_avg_wr_target_share",
        "hc_historical_avg_te_target_share",
        "hc_historical_avg_rb_target_share",
        "oc_historical_oc_profile_count",
        "oc_historical_oc_profile_seasons",
        "oc_historical_oc_profile_teams",
        "oc_historical_avg_pass_rate",
        "oc_historical_avg_run_rate",
        "oc_historical_avg_wr_target_share",
        "oc_historical_avg_te_target_share",
        "oc_historical_avg_rb_target_share",
    ],
...
DATASETS = [
    ...
    (
        "current_coaching_staff",
        DATA_DIR / "coaching" / "current_coaching_staff.parquet",
        "team-current-staff",
    ),
    (
        "offensive_coordinator_profiles",
...
def row_payload(row: pd.Series, source: str, source_path: Path, grain: str, row_key: str) -> dict[str, Any]:
    ...
    field_map = {
        ...
        "coordinator": ("oc_name", "dc_name", "current_oc_name"),
        "head_coach": ("hc_name", "current_hc_name"),
    }
...
def row_key(row: pd.Series, source: str, index: int) -> str:
    columns_by_source = {
        ...
        "current_coaching_staff": ["as_of_date", "team"],
...
def format_row(source: str, row: pd.Series) -> str:
    labels = {
        ...
        "current_coaching_staff": "Current coaching staff with historical profile links",
